...
# csd使用范例
data = c.csd("601688.SH,300059.SZ","close,high,low","2010-02-10","2010-05-10",'ispandas=0,ShowBlank=0')
...
# css使用范例
data = c.css("600634.SH,000009.SZ","SuspendDates,LIQHSHARE","TradeDate=20170308, Ispandas=0, ShowBlank=0")
print("css输出结果======分隔线======")
if not isinstance(data, c.EmQuantData):
    print(data)
else:
